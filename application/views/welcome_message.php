...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Codeigniter Insert batch</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row jumbotron">
                ...
                <div class="col-md-12">
                        ...
                        <button class="btn btn-sm btn-warning btn-remove-detail-row">Delete</button>
                        </fieldset>
        ...
        <script src="<?php echo base_url();?>assets/js/bootstrap-material-design/0.3.0/js/material.min.js"></script>
